    ...
    <div>
      ...
      <div className="mb-8 space-y-4">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-wrfc-red focus:border-transparent"
          />
        </div>
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-wrfc-red focus:border-transparent"
            >
      ...
      {filteredSpotlights.length === 0 && (
        <div className="text-center py-12">
          <p className="text-gray-600 dark:text-gray-100">No alumni found matching your criteria.</p>
        </div>
      )}
    </div>
  )
