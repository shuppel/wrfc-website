      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-bold font-nasalization">WRFC</h3>
            <p className="text-gray-600 dark:text-gray-400 font-jetbrains">
          ...
          {/* Quick Links */}
          <div className="space-y-4">
            <h4 className="text-lg font-bold font-nasalization">Quick Links</h4>
          ...
          {/* Resources */}
          <div className="space-y-4">
            <h4 className="text-lg font-bold font-nasalization">Resources</h4>
            <ul className="space-y-2">
          ...
          {/* Social Links */}
          <div className="space-y-4">
            <h4 className="text-lg font-bold font-nasalization">Connect</h4>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-800">
          <p className="text-center text-gray-600 dark:text-gray-400 font-jetbrains">
...
function FooterLink({ href, children }: { href: string; children: React.ReactNode }) {
  return (
    <Link 
      href={href}
      className="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 font-jetbrains transition-colors"
    >
      {children}
    </Link>
  )
