...
import { Dumbbell, Circle, User, FileText, Users, Building } from "lucide-react"
            ...
            {[
              {
                ...
                icon: <User size={48} strokeWidth={3} className="text-wrfc-red" />
              },
              {
                phase: "Conditioning",
                duration: "20 minutes",
                description: "Sport-specific fitness work including sprints, agility drills, and rugby-focused cardio.",
                icon: <Dumbbell size={48} strokeWidth={3} className="text-wrfc-red" />
              },
              {
                phase: "Skill Drills",
                duration: "25 minutes",
