...
export default function MediaPage() {
  ...
  const [instagramPosts, setInstagramPosts] = useState<string[]>([
    'https://www.instagram.com/p/C2eLaUDusK8/', // Replace with actual post URLs from WRFC's Instagram
    'https://www.instagram.com/p/C2iUxmKuCxp/', 
    'https://www.instagram.com/p/C2Y8JCru5Lt/',
    'https://www.instagram.com/p/C24LM5RuGRV/'
  ]);
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {activeTab === 'instagram' && (
          <div className="py-8">
            <h2 className="text-2xl font-bold mb-8 text-center">WRFC Instagram Feed</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {instagramPosts.map((postUrl, index) => (
                <div key={index} className="instagram-post-container bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
                  <blockquote
                  ...
                  >
                    <div style={{ padding: '16px' }}>
                      ...
                      <p style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', lineHeight: '17px', marginBottom: '0', marginTop: '8px', overflow: 'hidden', padding: '8px 0 7px', textAlign: 'center', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                        <a href={postUrl} style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', fontStyle: 'normal', fontWeight: 'normal', lineHeight: '17px', textDecoration: 'none' }} target="_blank" rel="noopener noreferrer">
                          A post shared by Washington Rugby (@wrfc1963)
                        </a>
                      </p>
                    </div>
                  </blockquote>
