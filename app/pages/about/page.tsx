...
export default function AboutPage() {
  const aboutLinks = [
    ...
    { href: '#vision', icon: '🎯', label: 'Vision & Leadership' },
    { href: '#experience', icon: '💼', label: 'Professional Experience' },
    { href: '#organizations', icon: '🤝', label: 'Professional Organizations' },
    { href: '#learning', icon: '📚', label: 'Open Source Learning' },
    { href: '#tech-stack', icon: '💻', label: 'Technology Stack' },
  ]
    ...
    <div className="min-h-screen bg-gradient-to-b from-background-light to-white dark:from-background-dark dark:to-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative">
        <div className="space-y-12">
          ...
          <div id="organizations" className="scroll-mt-16">
          ...
          {/* Tech Stack Section */}
          <div id="tech-stack" className="scroll-mt-16">
            <Card className="p-8 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm hover:shadow-xl transition-all duration-300">
      ...
      {/* QuickNav with explicit z-index */}
      <div className="relative z-50">
        <QuickNav links={aboutLinks} />
      </div>
    </div>
  )
} 