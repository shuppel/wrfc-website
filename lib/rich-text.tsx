...
const options = {
  ...
  renderNode: {
    [BLOCKS.HEADING_1]: (node: any, children: React.ReactNode) => <h1 className="text-4xl font-bold mt-8 mb-4">{children}</h1>,
    [BLOCKS.HEADING_2]: (node: any, children: React.ReactNode) => <h2 className="text-3xl font-bold mt-8 mb-4">{children}</h2>,
    [BLOCKS.HEADING_3]: (node: any, children: React.ReactNode) => <h3 className="text-2xl font-bold mt-6 mb-3">{children}</h3>,
    [BLOCKS.HEADING_4]: (node: any, children: React.ReactNode) => <h4 className="text-xl font-bold mt-6 mb-3">{children}</h4>,
    [BLOCKS.HEADING_5]: (node: any, children: React.ReactNode) => <h5 className="text-lg font-bold mt-4 mb-2">{children}</h5>,
    [BLOCKS.HEADING_6]: (node: any, children: React.ReactNode) => <h6 className="text-base font-bold mt-4 mb-2">{children}</h6>,
